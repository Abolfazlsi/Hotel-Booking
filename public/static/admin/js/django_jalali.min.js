// Took from https://unpkg.com/@majidh1/jalalidatepicker@0.9.10/dist/jalalidatepicker.min.js
!function () {
    "use strict";
    !function () {
        var t = void 0;
        ...
        var e = function (t) {
                ...
                var i = s(n, e), o = t.initDate, a = t.options.maxDate, r = t.options.minDate, h = i.year, u = i.month,
                    d = i.day;
                ...
                var i = s(n, e), o = t.initTime, a = t.options.maxTime, r = t.options.minTime, h = i.hour, u = i.minute,
                    d = i.second;
            ...
            S = "div.".concat(v, "-day.disable-day"), M = "".concat(I, ".disabled-day"),
        ...
        var at, rt, st = function (t, n) {
            ...
            o.tabIndex = -1;
            for (var a, r, h = (a = s({hour: 0, minute: 0, second: 0}, t.options.minTime), r = s({
                hour: 23,
                minute: 59,
                second: 59
            ...
            pt(t), function (t) {
                ...
                for (var o = function (n) {
                    ...
                    u.day = a.day, u.month = a.month, u.year = a.year, a.isValid && u.addEventListener(z, (function () {
                        t.setValue({year: u.year, month: u.month, day: u.day})
                    })), o(a)
                }, w = 0; w <= u; w++) D(w)
            }(t)
        }, lt = function (t) {
